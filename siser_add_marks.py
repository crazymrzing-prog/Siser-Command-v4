...
layer. This is the same "Marks" layer siser_reference.py reads for
ContourCut mode (get_contour_marks/get_contour_mark_paths).

Callable directly as run_add_marks(svg, ...) - e.g. from
siser_command_model_c.py's effect() when Output is set to "Add
...
# siser_command_model_c.py calls run_add_marks() directly instead)
# ==========================================================
