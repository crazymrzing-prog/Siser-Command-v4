...
from siser_geometry import flatten_superpath_to_subpaths
from siser_constants import FLATTEN_TOLERANCE_MM
...
def _reference_wysiwyg(svg):
    ...
    # once the Siser axis-swap is applied to the real output.
    #
