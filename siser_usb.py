...
sending a job to the Siser cutter (USB ID 0483:5750) over USB.

Used by siser_output.py's send_hpgl_usb(), called from
siser_command_d24_1.py's "Send to Machine USB" action.
...
def friendly_label(path):
    ...
    #   \\?\usb#vid_0483&pid_5750#siser_5503#{28d78fad-5a12-11d1-ae5b-0000f803a8c2}
...
def pick_and_send(paths, payload, title="Siser - Send to Machine USB"):
    """
    ...
    tk.Label(
        root,
        text="Siser(s) found (USB-Printer class, VID 0483:PID 5750) - pick one:",
        anchor="w",
